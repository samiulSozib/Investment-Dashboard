...
import {bestPerformingBusinessList} from '../../redux/actions/bestPerformingBusinessActions'

const BestPerformingBusiness = () => {
  ...
  const {loading,error,bestPerformingBusinesss} =useSelector((state)=>state.bestPerformingBusiness)

  useEffect(()=>{
    dispatch(bestPerformingBusinessList())
  },[dispatch])
...
export default BestPerformingBusiness;
